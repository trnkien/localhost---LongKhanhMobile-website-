						...
						<tbody>
							...
							@endforeach
								<tr>
									...
									<td><a class="btn btn-default check_out" href="{{url('/del-all-product')}}">Xoá hết tất cả sản phẩm</a></td>
									<td>
											...
											<li>
												@foreach(Session::get('coupon') as $key => $cou)
													@if($cou['coupon_condition']==1)
														...
														<p><li>Tổng tiền sau khi đã giảm giá:{{number_format($total-$total_coupon,0,',','.')}} VNĐ</li></p>
													@elseif($cou['coupon_condition']==2)
														Mã giảm: {{number_format($cou['coupon_number'],0,',','.')}} k
															...
															<p><li>Tổng tiền sau khi đã giảm giá: {{number_format($total_coupon,0,',','.')}} VNĐ</li></p>
													@endif
												@endforeach
											</li>
										@endif
