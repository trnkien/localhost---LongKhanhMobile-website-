					...
					<tbody>
						@foreach($content as $v_content)
							<tr>
								...
								<td class="cart_price">
									<p>{{number_format($v_content->price).' đồng'}}</p>
								</td>
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							<li>Tổng<span>{{Cart::total().' đồng'}}</span></li>
							<li>Thuế<span>{{Cart::tax().' đồng'}}</span></li>
							<li>Phí vận chuyển<span>Free</span></li>
							<li>Thành tiền<span>{{Cart::total().' đồng'}}</span></li>
						</ul>
